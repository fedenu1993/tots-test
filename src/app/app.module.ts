...
import { TOTS_TABLE_DEFAULT_CONFIG, TotsTableModule, TotsTableDefaultConfig } from '@fedenu_1993/table';
import { TotsDateColumnModule } from '@fedenu_1993/date-column';
import { TotsEditableColumnsModule } from '@fedenu_1993/editable-columns';
